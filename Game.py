...
# The Number or particles to create for my particle effects
PARTICLE_COUNT = 500
...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        # Create a list to hold onto our burst particle effect
        self.burst_list = []
        
        # Program to visualize the points
        self.program = self.ctx.load_program(
                vertex_shader = "resources/shaders/shapes/vertex_shader_v1.glsl",
                fragment_shader = "resources/shaders/shapes/fragment_shader.glsl",
        )
        
        self.ctx.enable_only(self.ctx.BLEND)
        
        # A timer to help slow down the rate at which bursts appear
        ...
        if self.game_over:
            ...
            def _gen_initial_data(initial_x, initial_y):
                ...
                for i in range(PARTICLE_COUNT):
                    ...
                    splat = random.choice([True, False])
                    if splat:
            ...
            def _gen_burst_data():
                # Recalculate the coordinates from prixels to the OpenGL system with
                # 0, 0 at the center.
                random_point = random.choice(PARTICLE_POSITIONS)
                x2 = random_point[0]
                y2 = random_point[1]
    ...
    def on_draw(self):
        ...
        # If the game is over, display you win sign
        if self.game_over:
            # Draw you win screen
